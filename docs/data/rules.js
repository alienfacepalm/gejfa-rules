...
const GEJFA_RULES = [
  ...
  },
  {
    ...
    levels: ["all"],
    answer: "Weigh-ins may start 1 hour before game time and no later than 50 minutes before — ideally visitors at 55 minutes out, home at 50. If the visitors aren't ready when called, the home team may weigh first.",
  ...
  },
  {
    ...
    text: "The score management rules of paragraph 10 apply; the trailing team starts offense from midfield, the leading team starts offense from its own 15. The substitution rule of paragraph 7 applies as does any other game management rule not altered by the 8 Player Football format.",
  ...
  },
  {
    ...
    levels: ["all"],
    answer: "A foul on any play preceding what would have been a kickoff (e.g., roughing the kicker or unsportsmanlike on a successful PAT) is assessed from the spot where play resumes (the new possession spot).",
  ...
  },
  {
    ...
    levels: ["all"],
    answer: "Margin of victory has NO effect on standings or playoff seeding — ever. There is no reason to run up a score.",
  ...
  },
  {
    ...
    levels: ["all"],
    answer: "8-game regular season in two Conferences (split into Divisions if >20 teams at the level). Standings: WIN = 2 points, TIE = 1, LOSS = 0. Everyone plays at least 9 games (8 + a playoff or matchup game in week 9). Non-counting games (bye-balancing) don't affect standings but CAN be used for tiebreakers.",
    text: "There will be two Conferences at each level, each with one Division (20 or fewer teams) or two Divisions (more than 20 teams). Teams play a round robin schedule of eight regular season games. For win/loss record placement purposes games count as follows: 2 points for a win, 1 point for a tie, no points for a loss. ALL TEAMS will play at least nine (9) games — eight regular season games and at least one playoff game or consolation game. Non-counting games will be identified and noted on the schedule at the start of the season; while they do not count in the standings, they can be used for tie-breaker purposes.",
  ...
  },
  {
    ...
    levels: ["all"],
    answer: "Two GEJFA teams may arrange their own matchup (arrange the field, notify the President and scheduler via Club Director by 6 PM Sunday before). Playing a NON-GEJFA team: the Club Director must review the opponent's roster (birth dates + weights) to confirm no players exceed GEJFA formula point totals. Bye-week inter-league or practice games are allowed subject to Council review.",
...
if (typeof module !== "undefined" && module.exports) {
  module.exports = { GEJFA_RULES, GEJFA_CATEGORIES, GEJFA_LEVELS };
}
